      ...
      <div class="container mt-4 mb-5">
        <div class="row">
          <div class="col d-flex justify-content-center space-between">
            Students show learning: Students use built-in annotation tools to
            capture what they know in Seesaw’s digital portfolio
          </div>
          <div class="col d-flex justify-content-center space-between">
            Teachers gain insights: Teachers deeply understand student thinking
            and progress — enabling them to teach better
          </div>
          <div class="col d-flex justify-content-center space-between">
            Families connect: Families gain a window into their student’s
            learning and engage with school happenings
          </div>
        </div>
      </div>
    </div>
